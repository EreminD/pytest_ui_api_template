...
def api_client() -> BoardApi:
    return BoardApi(ConfigProvider().get("api", "base_url"), "61790ff29348904bc42217da/ATTSuG9eBENjDVWwfSBeZYy87yFvmtn3tzC5BZDqAp3grYKklpMHzlXdbU01zpzdRS9h83679F3F")
...
def dummy_board_id() -> str:
    api = BoardApi(ConfigProvider().get("api", "base_url"), "61790ff29348904bc42217da/ATTSuG9eBENjDVWwfSBeZYy87yFvmtn3tzC5BZDqAp3grYKklpMHzlXdbU01zpzdRS9h83679F3F")
